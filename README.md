 ...
 * `serc --port=8080 --root=./public --ssl_cert_keys=./con/server`	=> this will start a https server on port 8080 to host all your files in ./public directory, the public key and certificates will be "./con/server.crt" and  private key will be "./con/server.key".
