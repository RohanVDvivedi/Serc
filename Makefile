...
BOOTSTRAP_SOURCES=${OBJ_DIR}/${BOOTSTRAPFILES}/distributer.o ${OBJ_DIR}/${BOOTSTRAPFILES}/httpobject.o ${OBJ_DIR}/${BOOTSTRAPFILES}/responseStrings.o ${OBJ_DIR}/${BOOTSTRAPFILES}/serve.o ${OBJ_DIR}/${BOOTSTRAPFILES}/strhsh.o
