...
BOOTSTRAP_SOURCES=${OBJ_DIR}/${BOOTSTRAPFILES}/distributer.o ${OBJ_DIR}/${BOOTSTRAPFILES}/response_strings.o ${OBJ_DIR}/${BOOTSTRAPFILES}/http_server.o ${OBJ_DIR}/${BOOTSTRAPFILES}/strhsh.o ${OBJ_DIR}/${BOOTSTRAPFILES}/http_object.o ${OBJ_DIR}/${BOOTSTRAPFILES}/file_request_resolution_controller.o ${OBJ_DIR}/${BOOTSTRAPFILES}/file_handler.o
